/**
 * Apply call_signals RLS policy fix to include can_place_call check
 * Requires SUPABASE_ACCESS_TOKEN or token in .env.local
 *
 * Usage:
 *   node scripts/apply-calls-rls-fix.mjs
 */
...
const sql = readFileSync(
  join(root, "..", "supabase-calls-rls-fix.sql"),
  "utf8",
);
...
console.log("Call signals RLS policy fix applied.");
