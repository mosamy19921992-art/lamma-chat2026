/**
 * Apply can_place_call default for registered participants.
 * Requires SUPABASE_ACCESS_TOKEN or token in .env.local
 *
 * Usage:
 *   node scripts/apply-calls-permission-fix.mjs
 */
...
const sql = readFileSync(
  join(root, "..", "supabase-calls-permission-fix.sql"),
  "utf8",
);
...
console.log("Call permission fix applied.");
