/**
 * Apply only supabase-launch-hardening.sql (PM read-only + call_signals binding).
 *
 * Usage:
 *   $env:SUPABASE_ACCESS_TOKEN="sbp_..."
 *   node scripts/apply-launch-hardening-only.mjs
 */
...
const root = dirname(fileURLToPath(import.meta.url));
const sql = readFileSync(join(root, "..", "supabase-launch-hardening.sql"), "utf8");
...
console.log("Launch hardening SQL applied.");
